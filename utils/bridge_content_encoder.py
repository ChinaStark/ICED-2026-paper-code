"""
Encode DB content and fuzzy-match values to question text.
Ported locally from data_process/utils/bridge_content_encoder.py to avoid cross-package imports.
"""
    ...
    for field_value in field_values:
        ...
        if match.size > 0:
            ...
            if source_match:
                ...
                if c_match_str and not is_common_db_term(c_match_str):
